...
# icon
lower_frame = Frame(root , bg = "#FFFFFF", width = 485 , height = 180 )#485,180
lower_frame.place ( x = 0 , y = 800)
...
Button(root, image=ButtonPlay, bg="#FFFFFF", bd=0, height = 40, width =40,
